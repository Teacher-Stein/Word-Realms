...
// ===================== VOCABULARY 1: making music =========================
  ...
  { cover:"note", tier:1, type:"reason", open:false,
    clue:"One single sound in music, not several sounds together. What is it called?",
    answer:"a note", choices:["a note","a chord","a melody"] },
  ...
  { cover:"note", tier:2, type:"reason", open:false,
    clue:"Say what a note is in music.",
  ...
  { cover:"chord", tier:1, type:"reason", open:false,
    clue:"A chord is not one single sound. Say what it really is.",
  ...
  { cover:"melody", tier:2, type:"reason", open:false,
    clue:"You hum the melody of a song. Say how a melody's notes are played.",
  ...
  { cover:"beat", tier:3, type:"reason", open:false,
    clue:"A drummer keeps the beat all the way through a song. Say what the beat is.",
  ...
  { cover:"rhythm", tier:3, type:"reason", open:false,
    clue:"Say what rhythm is in music.",
  ...
  { cover:"practice", tier:3, type:"grammar", open:false,
    clue:"Say it correctly: 'I practices the violin every morning.'",
  ...
  { cover:"perform", tier:2, type:"reason", open:false,
    clue:"Say what the word 'perform' means for a musician.",
  ...
  { cover:"concert", tier:2, type:"reason", open:false,
    clue:"In music, what do we call an event that people go to - not a person and not a sound?",
  ...
  { cover:"lead_singer", tier:2, type:"reason", open:false,
    clue:"Say what the lead singer of a band does.",
...
// ===================== VOCABULARY 1: the instruments ======================
  ...
  { cover:"violin", tier:2, type:"reason", open:false,
    clue:"Say how you make a sound on a violin.",
  ...
  { cover:"drum", tier:1, type:"vocab", open:false,
    clue:"A violin, a flute and a drum are on stage. Say the one that belongs to the percussion family.",
    answer:"a drum", choices:["a drum","a flute","a violin"] },
  ...
  { cover:"drum", tier:3, type:"grammar", open:false,
    clue:"Say it correctly: 'He has play the drum since he was six.'",
  ...
  { cover:"piano", tier:1, type:"vocab", open:false,
    clue:"A saxophone, a drum and a piano are on stage. Say the one from the keyboard family.",
  ...
  { cover:"piano", tier:2, type:"reason", open:false,
    clue:"Say how a piano makes a sound.",
  ...
  { cover:"flute", tier:1, type:"vocab", open:false,
    clue:"A drum, a violin and a flute are on stage. Say the one from the wind family.",
  ...
  { cover:"flute", tier:2, type:"reason", open:false,
    clue:"Say how you make a sound on a flute.",
  ...
  { cover:"saxophone", tier:3, type:"grammar", open:false,
    clue:"Say it correctly: 'She has played the saxophone since two years.'",
...
// ============== VOCABULARY 2: genres, and the /ɔ/ sound ===================
  ...
  { cover:"classical", tier:2, type:"vocab", open:false,
    clue:"Violins, guitars, flutes, computers, drums - say the three you would find in a classical orchestra.",
  ...
  { cover:"rock", tier:2, type:"vocab", open:false,
    clue:"Rock, a guitar, jazz, a drum, pop, a concert - say the three that are kinds of music.",
  ...
  { cover:"phonics-o", tier:3, type:"phonics", open:false, noBlind:true,
  ...
  { cover:"phonics-o-not", tier:2, type:"phonics", open:false, noBlind:true,
...
// ========== GRAMMAR 1 & 2: present perfect, comparative adverbs ===========
  ...
  { cover:"adv-more", tier:3, type:"grammar", open:false,
    clue:"Say it correctly: 'Nam practices oftener than his sister.'",
  ...
  { cover:"adv-irregular", tier:3, type:"grammar", open:false,
    clue:"Say it correctly: 'She is a well singer and she sings well.'",
...
// ============ CARRIED FORWARD: going to, zero conditional, tags ===========
  ...
  { cover:"review-going-to", tier:2, type:"grammar", open:false,
    clue:"The drummer has no plan to play today. Say that with 'going to'.",
  ...
  { cover:"review-conditional", tier:1, type:"reason", open:false,
    clue:"This is always true: hitting a drum harder makes it louder. Say it as an 'if' sentence.",
  ...
  { cover:"review-conditional", tier:3, type:"grammar", open:false,
    clue:"Say the same thing starting with 'A flute': 'If you blow across the hole, the flute makes a sound.'",
...
const REALM3_ELITE_QUESTIONS = [
  ...
  { cover:"drum", tier:4, type:"reason", open:false,
    clue:"Put a drum and a piano in their right families. Say it in one sentence with 'but'.",
  ...
  // ---- phonics-o ----
  { cover:"phonics-o", tier:4, type:"phonics", open:false, noBlind:true,
  ...
  // ---- phonics-o-not ----
  { cover:"phonics-o-not", tier:4, type:"phonics", open:false, noBlind:true,
  ...
  { cover:"pp-participle", tier:4, type:"reason", open:false,
    clue:"Lan is at the concert now. Tam came home an hour ago. Say it with 'has gone' and 'has been'.",
  ...
  { cover:"review-going-to", tier:4, type:"grammar", open:false,
    clue:"Your friend says: 'The drummers is going to played first.' Say it correctly.",
  ...
  { cover:"review-conditional", tier:4, type:"grammar", open:false,
    clue:"Your friend says: 'If you blows into the flute, it make a sound.' Say it correctly.",
  ...
  { cover:"review-tags", tier:4, type:"grammar", open:false,
    clue:"Say it correctly: 'Your sister hasn't heard the song, isn't she?'",
